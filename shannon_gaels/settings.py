"""
Django settings for shannon_gaels project.
...
SECRET_KEY = 'collectstaticneedsaprintedsecretkey'
...
WSGI_APPLICATION = 'shannon_gaels.wsgi.application'
...
if 'USE_AWS' in os.environ:
    ...
    AWS_STORAGE_BUCKET_NAME = 'ci-mp4-shannongaels'
